...
import 'package:flutter_project/reusable_widgets/buildimages.dart';
...
class onbordingview extends StatelessWidget {
      ...
      body:IntroductionScreen(
        pages: [
          PageViewModel(
            ...
            image: const BuildImages(image: 'assets/images/image 2.png'),
            decoration: getPageDecoration(),
          ),
          PageViewModel(
            title: 'Popular MakeUp products Brands',
            body: 'shop popular makeup products from beauty essentials.',
            image: const BuildImages(image: 'assets/images/image 3.png'),
            decoration: getPageDecoration(),
          ),
          PageViewModel(
            ...
            image: const BuildImages(image: 'assets/images/image 4.png'),
            decoration: getPageDecoration(),
          ),
        ],
  ...
  DotsDecorator getDotDecoration() {
    return DotsDecorator(color: Colors.purple,
